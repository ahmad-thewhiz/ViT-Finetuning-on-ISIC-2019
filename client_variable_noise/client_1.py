...
client_name = "client_1_var_noise_train_on"
...
def load_data():
    ...
    trainloader = DataLoader(train_dataset[0], batch_size=PARAMS["batch_size"])
    testloader = DataLoader(test_dataset, batch_size=PARAMS["batch_size"])
    sample_rate = PARAMS["batch_size"] / len(train_dataset[0])
