...
federated_ox_flowers, _ = get_dataset_with_partitions(num_partitions=6)


def client_fn(cid: str):
    """Return a FedViTClient that trains with the cid-th data partition."""

    trainset_for_this_client = federated_ox_flowers[int(cid)]

    # trainset = trainset_for_this_client.with_transform(apply_transforms)
    trainset = trainset_for_this_client
